...
![RDS PostgreSQL Single-AZ summary](/fcj_workshop_huyentrang/images/5-Workshop/5.7-RDS-Secrets-Worker-Pipeline/5.7.1.png)

RDS sử dụng private connectivity, public access disabled, endpoint và port 5432.

![RDS private connectivity and endpoint](/fcj_workshop_huyentrang/images/5-Workshop/5.7-RDS-Secrets-Worker-Pipeline/5.7.2.png)

Security Group chỉ cho backend/worker truy cập PostgreSQL 5432.

![RDS security group inbound rule](/fcj_workshop_huyentrang/images/5-Workshop/5.7-RDS-Secrets-Worker-Pipeline/5.7.3.png)
...
![RDS secret stored in Secrets Manager with value ](/fcj_workshop_huyentrang/images/5-Workshop/5.7-RDS-Secrets-Worker-Pipeline/5.7.4.png)
...
![RDS connectivity test from EC2 or worker](/fcj_workshop_huyentrang/images/5-Workshop/5.7-RDS-Secrets-Worker-Pipeline/5.7.5.png)
...
![Final alerts table in PostgreSQL](/fcj_workshop_huyentrang/images/5-Workshop/5.7-RDS-Secrets-Worker-Pipeline/5.7.6.png)
...
![AI worker systemd service status](/fcj_workshop_huyentrang/images/5-Workshop/5.7-RDS-Secrets-Worker-Pipeline/5.7.7.png)
...
![AI worker processed SQS message](/fcj_workshop_huyentrang/images/5-Workshop/5.7-RDS-Secrets-Worker-Pipeline/5.7.8.png)
...
![Final alert row stored in RDS](/fcj_workshop_huyentrang/images/5-Workshop/5.7-RDS-Secrets-Worker-Pipeline/5.7.9.png)
...
![Latest alert returned by backend API](/fcj_workshop_huyentrang/images/5-Workshop/5.7-RDS-Secrets-Worker-Pipeline/5.7.10.png)
