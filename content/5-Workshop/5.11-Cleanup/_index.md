...
![RDS final_alerts evidence](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/10-rds-final-alerts-evidence.png)
...
![Terminate backend and worker instances](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/01-ec2-terminate-backend-worker.png)
...
![Delete ALB action](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/02-alb-delete-menu.png)

![Confirm ALB deletion](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/03-alb-delete-confirm.png)

![Delete target group](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/04-target-group-delete-menu.png)
...
![Main SQS queue deleted](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/05-sqs-main-queue-deleted.png)

![DLQ deleted](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/06-sqs-dlq-deleted.png)
...
![S3 data bucket content before deletion](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/07-s3-data-bucket-contents.png)

![S3 delete objects status](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/08-s3-delete-objects-status.png)

![S3 buckets deleted](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/09-s3-buckets-deleted.png)
...
![Delete RDS with final snapshot](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/11-rds-delete-final-snapshot.png)

![RDS delete confirmation](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/12-rds-delete-confirmation.png)

![RDS deleted](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/13-rds-deleted.png)
...
![Secrets Manager list before deletion](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/14-secrets-manager-list.png)

![Secret metadata before delete](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/15-secret-before-delete.png)

![Secret scheduled for deletion](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/16-secret-scheduled-deletion.png)
...
![CloudFront distributions disabled but under Pro plan](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/17-cloudfront-distributions-disabled-pro-plan.png)
...
![Only default behavior remains](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/18-cloudfront-default-behavior-only.png)
...
![CloudFront OAC retained](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/19-cloudfront-oac-retained.png)

*Caption:* OAC is retained because the distribution still exists and still
references the origin/OAC.

![CloudFront-created WAF protection pack](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/20-waf-created-by-cloudfront-pro-plan.png)
...
![IAM Identity Center users with MFA](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/21-iam-identity-center-users-mfa.png)

![IAM Identity Center groups before deletion](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/22-iam-identity-center-groups-before-delete.png)

![IAM Identity Center groups deleted](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/23-iam-identity-center-groups-deleted.png)
...
![CloudWatch log groups before deletion](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/24-cloudwatch-log-groups-before-delete.png)

![CloudWatch alarms before deletion](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/25-cloudwatch-alarms-before-delete.png)

![Delete CloudWatch log groups](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/26-cloudwatch-delete-log-groups-dialog.png)
...
![Delete VPC endpoint](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/27-vpc-endpoint-delete.png)

![Delete NAT Gateway](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/28-nat-gateway-delete.png)

![Release Elastic IP](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/29-release-elastic-ip.png)
...
![Delete route table](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/30-route-table-delete.png)

![Route table cleanup complete](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/31-route-table-cleanup-complete.png)

![VPC subnets before deletion](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/32-vpc-subnets-before-delete.png)

![Delete security group](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/33-security-group-delete.png)

![Internet Gateway before deletion](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/34-internet-gateway-before-delete.png)

![Delete Internet Gateway](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/35-internet-gateway-delete.png)

![VPC deletion complete](/fcj_workshop_huyentrang/images/5-Workshop/5.11-Cleanup/36-vpc-delete-complete.png)
