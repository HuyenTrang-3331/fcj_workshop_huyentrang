...
![Frontend source folder](/fcj_workshop_huyentrang/images/5-Workshop/5.4-Frontend-S3-CloudFront-WAF/w-phu-01-frontend-folder.png)
...
![Frontend environment ](/fcj_workshop_huyentrang/images/5-Workshop/5.4-Frontend-S3-CloudFront-WAF/w-phu-02-frontend-env.png)

The build output confirms that the frontend compiles successfully.

![Frontend build success](/fcj_workshop_huyentrang/images/5-Workshop/5.4-Frontend-S3-CloudFront-WAF/w-phu-03-frontend-build-success.png)

The `dist/` folder is the artifact that will be uploaded to the S3 Static Frontend Bucket.

![Frontend dist folder](/fcj_workshop_huyentrang/images/5-Workshop/5.4-Frontend-S3-CloudFront-WAF/w-phu-04-frontend-dist-folder.png)
